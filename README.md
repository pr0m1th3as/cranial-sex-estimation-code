...
To estimate the sex of a cranial sample, which has been pre-processed with the skullanalyzer program, utilize the function 'estimate_sex.m' found in the folder ./estimate_sex

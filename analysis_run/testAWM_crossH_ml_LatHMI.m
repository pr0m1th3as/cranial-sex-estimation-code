...
% of the left mastoid process area, generated with the skullanalyzer software
clear
iterations = 100

% create a unified list from all available occipital protuberance HMI files
ABH = dir("../HMI/ABH*mastoidLeftLateral*");
WLH = dir("../HMI/WLH*mastoidLeftLateral*");
MOTOL = dir("../HMI/MOTOL*mastoidLeftLateral*");
HOMOL = dir("../HMI/HOMOL*mastoidLeftLateral*");
...
for iter = 1:iterations
	...
	for i=1:length(Train_files)
		...
		new_name = ["Train" sprintf("%03d", i) "mlLatHMI.csv"];
		cmd_line = ["cp ../HMI/" old_name " " new_name];
		unix(cmd_line);
	...
	for i=1:length(Test_files)
		...
		new_name = ["Test" sprintf("%03d", i) "mlLatHMI.csv"];
		cmd_line = ["cp ../HMI/" old_name " " new_name];
		unix(cmd_line);
...
csvwrite("mlLat_results.csv", output);
save("mlLat_classification.mat", "classification" );

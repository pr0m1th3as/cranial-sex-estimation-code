...
ABH = dir("../HMI/ABH*mastoidLeftInferior*");
WLH = dir("../HMI/WLH*mastoidLeftInferior*");
MOTOL = dir("../HMI/MOTOL*mastoidLeftInferior*");
HOMOL = dir("../HMI/HOMOL*mastoidLeftInferior*");
...
for i = 1:length(Cross_files)
	...
	new_name = ["Cross" sprintf("%03d", i) "mlInfHMI.csv"];
...
for iter = 1:iterations
	...
	for i=1:length(Train_files)
		...
		new_name = ["Train" sprintf("%03d", i) "mlInfHMI.csv"];
		cmd_line = ["cp ../HMI/" old_name " " new_name];
		unix(cmd_line);
	...
	for i=1:length(Test_files)
		...
		new_name = ["Test" sprintf("%03d", i) "mlInfHMI.csv"];
		cmd_line = ["cp ../HMI/" old_name " " new_name];
		unix(cmd_line);
...
csvwrite("mlInf_results.csv", output);
save("mlInf_classification.mat", "classification" );
